...
US.DinnerPanel = class DinnerPanel {
  ...
  _pickElenaPose() {
    if (this.phase === 'ending') {
      ...
      // Fallback por id de ending: good → despedida, bad → ausente.
      if (this.ending && this.ending.id && /good/i.test(this.ending.id)) return 'despedida';
      if (this.ending) return 'ausente';
      return 'neutral';
    }
